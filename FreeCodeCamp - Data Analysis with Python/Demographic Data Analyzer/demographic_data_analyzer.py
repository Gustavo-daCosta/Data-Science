...
def calculate_demographic_data(print_data=True):
    ...
    country_df = df[~df['native-country'].isin(['?'])]
    highest_earning_country = (country_df[country_df['salary'] == '>50K']['native-country'].value_counts() / country_df['native-country'].value_counts()).idxmax()
